  ...
  return (
    ...
    >
      ...
      <div className="mt-4 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-[0_18px_46px_-36px_rgba(24,24,27,0.42)] dark:border-zinc-700/70 dark:bg-zinc-900/58 dark:shadow-[0_22px_54px_-38px_rgba(2,6,23,0.9)]">
        <div
          data-component-preview-frame=""
          className="min-h-[22rem] rounded-[inherit] sm:min-h-[24rem] md:min-h-[28rem]"
        >
          <div
            data-component-preview-frame-inner=""
            className="flex min-h-[22rem] items-center justify-center overflow-hidden rounded-[inherit] sm:min-h-[24rem] md:min-h-[28rem]"
          >
