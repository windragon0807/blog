...
export function Lanyard({
  ...
  return (
    <div className="relative z-0 flex h-full min-h-80 w-full origin-center scale-100 transform items-center justify-center">
      <Canvas
        camera={{ position, fov }}
...
function Band({
  ...
  const meshLineResolution = useMemo(
  ...
  return (
    <>
      ...
      <mesh ref={band}>
        <meshLineGeometry />
        <meshLineMaterial
          args={[{ resolution: meshLineResolution }]}
          color="white"
          depthTest={false}
          resolution={meshLineResolution}
          useMap={1}
          map={texture}
          repeat={[-4, 1]}
